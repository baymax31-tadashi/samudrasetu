                  ...
                  <CardContent className="p-0">
                    <div className="flex">
                      <div className="relative w-48 h-32">
                        ...
                        />
                        <Badge
                          className={`absolute top-2 right-2 ${getThreatLevelColor(report.threatLevel)} text-white`}
                        >
                          {report.threatLevel}
                        </Badge>
                      </div>
                        ...
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-sm text-muted-foreground">
                              {report.officialSources} official sources
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <Badge variant="default" className="text-green-600 bg-green-50">
                          <CheckCircle className="h-8 w-8 mr-1" />
                          Verified
                        </Badge>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        <Badge variant="destructive" className="bg-red-50 text-red-600">
                          <XCircle className="h-8 w-8 mr-1" />
                          Rejected
                        </Badge>
                        <p className="text-xs text-muted-foreground mt-1">
