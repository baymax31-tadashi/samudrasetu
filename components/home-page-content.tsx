        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full relative">
            <iframe
              ...
              src="https://www.youtube.com/embed/CMZxdCqYC3g?autoplay=1&mute=1&loop=1&playlist=CMZxdCqYC3g&controls=0&showinfo=0&rel=0&iv_load_policy=3&modestbranding=1&disablekb=1&fs=0&cc_load_policy=0&playsinline=1&enablejsapi=1&start=0&end=120&origin=https://v0.app&widget_referrer=https://v0.app&preload=auto"
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900/50 via-blue-800/30 to-teal-700/20 opacity-70 transition-opacity duration-1000" />
          </div>
